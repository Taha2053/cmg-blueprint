        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {articles.map((article) => (
            ...
            >
              ...
              <div className="bg-accent p-6 min-h-[120px] flex flex-col justify-center">
                <h3 className="font-serif text-xl text-white leading-snug group-hover:opacity-90 transition-opacity">
                  {article.title}
                </h3>
                {article.subtitle && (
